...
public class Seance_per_week extends AppCompatActivity implements IDayofWeekListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Seances de cette semaine");
        ...
        RecyclerView.LayoutManager linearLayoutManager = new LinearLayoutManager(Seance_per_week.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent myIntent = new Intent(Seance_per_week.this, MainActivity.class);
    ...
    public void getSeance_perweek(Context context) {
        try {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                    Request.Method.GET,
                    WebService.url + "seances/ByWeekNUser?id="+id,
                    null,
